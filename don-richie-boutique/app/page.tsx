...
import { PRODUCTS } from "@/data/donRichieProducts";

/**
 * Don Richie Boutique Demo
 * — Next.js 15 / React / Framer Motion
 * — Designed to be “oddly perfect”: balanced asymmetry, motion, and elegance.
 * — Built by Victor (Frontend Developer)
 */
...
export default function DonRichiePage(): JSX.Element {
  ...
  return (
    <main
      ref={containerRef}
      className="min-h-screen relative overflow-x-hidden bg-slate-50 dark:bg-[#070707] text-slate-900 dark:text-slate-100 transition-colors duration-500 antialiased selection:bg-amber-600 selection:text-white"
    >
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap gap-3 items-center">
              <motion.div whileHover={{ y: -3 }} whileTap={{ scale: 0.98 }}>
                <FancyButton href="#shop" className="bg-amber-600 text-black hover:bg-amber-500 dark:bg-amber-400 dark:text-black">
                  View Catalogue
                </FancyButton>
              </motion.div>
              <motion.div whileHover={{ y: -3 }} whileTap={{ scale: 0.98 }}>
            ...
            <p className="mt-4 text-sm text-slate-500 dark:text-slate-400">
              Demo by Victor — Frontend Developer. <br /> Built with Next.js 15 + Framer Motion.
            </p>
          </motion.div>
            ...
            >
              <div className="grid grid-cols-2">
                <div className="relative h-64 sm:h-80 md:h-96">
                  <Image src={PRODUCTS[0].img} alt={PRODUCTS[0].title} fill className="object-cover" priority />
                </div>
                <div className="relative h-64 sm:h-80 md:h-96">
                  <Image src={PRODUCTS[1].img} alt={PRODUCTS[1].title} fill className="object-cover" priority />
                </div>
              </div>
            ...
            {PRODUCTS.map((p, i) => {
              const offsetClass =
                i % 3 === 0
                  ...
                  : i % 3 === 1
                  ? "translate-y-1 md:translate-y-4"
                  : "";
              return (
                <motion.article
                  key={p.id}
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
                      Handpicked fabric • Ready-to-order
                    </p>
      ...
      <section className="relative z-10 py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-300 mb-6">
            I build catalogues that match your brand personality and convert through direct WhatsApp ordering.
          </p>
          <div className="flex items-center justify-center gap-4">
            <FancyButton
              href="https://wa.me/234XXXXXXXXXX?text=Hi%20I%20want%20a%20Don%20Richie%20style%20site"
